...
def make_sequence_recall_tapes():
    ...
    train_inputs, train_targets = sequence_recall(vocab_size=vocab_size, num_examples=num_train_examples, input_seq_len=seq_len, seed=42, stacked=True)
    valid_inputs, valid_targets = sequence_recall(vocab_size=vocab_size, num_examples=num_valid_examples, input_seq_len=seq_len, seed=43, stacked=True)
